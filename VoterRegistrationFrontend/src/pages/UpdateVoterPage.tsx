          ...
          <div className="text-center mb-12">
            ...
            >
              ...
              <span className="text-sm font-semibold text-primary">
                मतदाता पहचान पत्र अपडेट | Voter ID Update
              </span>
            </div>
            <h1
            ...
            >
              Update Your Voter ID
            </h1>
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-foreground mb-4">
              Correct Details, Stay Eligible to Vote
            </h2>
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              Easily update your voter ID details such as name, address, or
              photo online. Keep your information accurate to ensure hassle-free
